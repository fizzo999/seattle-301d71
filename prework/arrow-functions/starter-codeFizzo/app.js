...
Student.prototype.greeting = function () {
  return `Hi, my name is ${this.name} and my age is ${this.hometown * 2.5} years`;
};
...
// it comes back as undefined - but it should refer back to the object(joe) that is instance of the constructor function
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// this refers back to the window object - arrow functions do not "port" this reference through but point back to the window object
//
// 3. Explain why "this" is different when an arrow function is used.
// it does not refer to the object BUT TO THE WINDOW OBJECT 
//
